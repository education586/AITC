...
export default function GraduateDiplomaPage() {
  ...
  const handleDownloadBrochure = () => {
    ...
    const file = new Blob([
      `Official Brochure & Syllabus for Course Code: BSB80120\n` +
      `Course Name: Graduate Diploma of Management (Learning)\n` +
      `CRICOS Registered: 113031J\n` +
      `Course Duration: 52 weeks (44 weeks tuition + 8 weeks break)\n` +
      `Delivery Mode: Face to face mode of delivery consisting of face to face physical and face to face virtual (20 hours total per week).`
    ], { type: 'text/plain' });
    element.href = URL.createObjectURL(file);
    element.download = `AITC_Brochure_BSB80120.txt`;
  ...
  const coreUnits = [
    { code: 'BSBHRM613', name: 'Contribute to the development of learning and development strategies' },
    { code: 'BSBLDR811', name: 'Lead strategic transformation' },
    { code: 'TAELED803', name: 'Implement improved learning practice' }
  ];

  const electiveUnits = [
    { code: 'BSBSTR801', name: 'Lead innovative thinking and practice' },
    { code: 'PSPMGT006', name: 'Develop a business case' },
    { code: 'BSBHRM611', name: 'Contribute to organisational performance development' },
    { code: 'BSBINS603', name: 'Initiate and lead applied research' },
    { code: 'BSBLDR812', name: 'Develop and cultivate collaborative partnerships and relationships' }
  ];
  ...
  const entryRequirements = [
    'Successful completion of equivalent of Australian Year 12 and must be 22 years old and above.',
    'Successful completion of Advanced Diploma Qualification or Bachelor’s Degree or work experience in the field of organisational learning and capability development.',
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans pb-28 text-slate-800">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2.5 mb-6 select-none">
              <span className="px-4 py-1.5 bg-white/5 text-slate-200 rounded-full text-[10px] font-extrabold uppercase tracking-widest border border-white/10 shadow-sm">
                Course Code: <span className="text-brand-red font-mono font-black ml-1 text-sm">BSB80120</span>
              </span>
      ...
      {/* 2. STICKY SUBMENU */}
      <section className="sticky top-20 bg-[#121113] text-[16px] text-slate-300 font-bold uppercase font-display select-none shadow-md z-40 border-t border-white/5">
          ...
          {[
            ...
            <button
              ...
              className={`px-5 sm:px-6 py-4.5 border-b-4 hover:text-white cursor-pointer tracking-wider shrink-0 transition-all font-bold ${
                activeAnchor === tab.id 
                  ? 'border-[#d22129] text-white bg-white/[0.04]' 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <div id="overview" className="scroll-mt-36 space-y-8 bg-white p-8 md:p-10 rounded-3xl border border-slate-150 shadow-sm animate-fade-in">
              ...
              <div className="text-[16px] text-slate-600 leading-relaxed font-sans space-y-4">
                <p>
                ...
                <div className="pt-4">
                  <h3 className="font-extrabold text-slate-800 text-[16px] mb-2 font-display uppercase tracking-widest text-[#d22129]">Licensing/Regulatory Information</h3>
                  <p>
            ...
            <div id="entry-requirements" className="scroll-mt-36 space-y-6 bg-white p-8 md:p-10 rounded-3xl border border-slate-150 shadow-sm animate-fade-in font-sans">
              <div className="border-l-4 border-brand-red pl-4">
                <h2 className="font-display font-extrabold text-[25px] text-slate-900 tracking-tight uppercase">
                  Entry Requirements
                </h2>
              ...
              <div className="space-y-4 pr-3 font-sans text-[16px] text-slate-600 leading-relaxed">
                {entryRequirements.map((req, idx) => (
                  <p key={idx} className="flex gap-3 items-start font-sans">
                ...
                <div className="pt-2 space-y-4">
                  <h3 className="font-extrabold text-slate-800 text-[14px] font-display uppercase tracking-widest text-brand-red">English requirements:</h3>
                  <p className="flex gap-3 items-start font-sans">
                    <span className="shrink-0 h-2 w-2 bg-brand-red rounded-full mt-2" />
                    <span className="font-medium text-slate-700">English requirement of a minimum of IELTS 6.5 or equivalent</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div id="qualification-issued" className="scroll-mt-36 bg-white p-8 md:p-10 rounded-3xl border border-slate-150 shadow-sm space-y-6 animate-fade-in font-sans">
              ...
              <p className="text-[16px] text-slate-600 leading-relaxed pr-4">
                Once the units of competency required in the training package for this qualification have been successfully completed, the student will be issued with the BSB80120 – Graduate Diploma of Management (Learning) and an academic transcript of all completed units within 30 calendar days. Students who successfully complete individual units of competency within the qualification, but not the qualification in its entirety will be eligible to receive a Statement of Attainment. This document contains a record of all completed units and will be available to students by the end of their course.
              </p>

              <div className="border border-brand-red/20 bg-red-50/20 p-6 rounded-2xl space-y-3.5 text-[16px] leading-relaxed text-slate-700 shadow-3xs">
                <h4 className="font-display font-black text-brand-red text-[16px] uppercase tracking-widest border-b border-brand-red/10 pb-2 font-bold font-sans">
                ...
                <div className="border-t border-slate-200/50 pt-3 space-y-2">
                  <p className="text-[16px] font-semibold text-slate-600 font-sans">
            ...
            >
              ...
              {modalSuccess ? (
                <div className="py-8 text-center space-y-4">
                  ...
                  <div>
                    <h4 className="font-display font-bold text-base text-slate-800 font-sans">Question Logged Successfully</h4>
